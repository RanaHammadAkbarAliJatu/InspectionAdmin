...
class Main extends Component {
  ...
  render() {
    const { done, draft } =this.props.route.params.dataToSend
    console.log( this.props.route.params.dataToSend," this.props.route.params.dataToSend")
    return (
      <View
        ...
        <SafeAreaView style={{ flex: 1 }}>
          <ScrollView bounces={false} style={{ flex: 1 }}>
            ...
            <View style={{ flex: 1, width: SCREEN.width - 40, alignSelf: "center", alignItems: 'center' }}>
              ...
              <TouchableOpacity style={styles.itemView}
                onPress={() => this.props.navigation.navigate("UpdateCurrentReport")}
                >
