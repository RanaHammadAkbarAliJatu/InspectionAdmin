...
function HeaderWithLogoandText({ leftPress, leftIcon, title, rightPress, centerText, centerIcon, boldtext, rightIcon, righText, borderBottom, borderLeftRadius, borderRightRadius, show = true }) {
  return (
